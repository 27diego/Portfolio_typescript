  ...
  const [Cards] = useState([
    {
      ...
      header: 'Design',
      paragraph:
        'From a sketch pad to Adobe XD I design the components on my projects coming up with the best looking UI possible, animations and color schemes',
      hiddenDes: {
        title1: 'UX',
        paragraph1:
    ...
    },
    {
      ...
      header: 'Develop',
      paragraph:
        'Every project of mine is developed in an organic way by sticking to designs and using pure scss and javascript I am able to develop components from scratch and make them come to life',
      hiddenDes: {
        title1: 'Development',
        paragraph1:
          'Once the UX & UI design is in place and I have a visual mockup ready, it will then be time for implementation. To do this, I go through my toolbox and choose the right tools for the job. At the end of the day it will be my job to implement all the features of the website and choose right amount of tools and dependencies to make the application run in the most efficient way possible.',
        title2: 'Production',
        paragraph2:
