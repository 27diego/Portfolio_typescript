          ...
          <div className={`container--icon container--icon--${theme}`}>
            <svg
              ...
              onClick={() => {
                setSelected(mongodb);
                setModal(true);
                setActive(active === "mongodb" ? "" : "mongodb");
              }}
            >
          ...
          <div className={`container--icon container--icon--${theme}`}>
            <svg
              ...
              onClick={() => {
                setSelected(docker);
                setModal(true);
                setActive(active === "docker" ? "" : "docker");
              }}
            >
          ...
          >
            <svg
              ...
              onClick={() => {
                ...
                setModal(true);
                setActive(active === "postgresql" ? "" : "postgresql");
              }}
            >
